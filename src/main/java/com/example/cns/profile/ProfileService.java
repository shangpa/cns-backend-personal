...
package com.example.cns.profile;

import com.example.cns.User.UserEntity;
import com.example.cns.User.UserRepository;
import com.example.cns.profile.follow.Follow;
import com.example.cns.profile.follow.FollowRepository;
import com.example.cns.profile.follow.FollowUserResponse;
import com.example.cns.recipe.RecipeRepository;
import com.example.cns.shorts.ShortsVideoRepository;
...
public class ProfileService {
    ...
    public boolean toggleFollow(int requesterUserId, int targetUserId) {
        ...
        if (exists) {
            ...
            var follow = com.example.cns.profile.follow.Follow.builder()
                    .follower(follower)
                    .following(following)
                    .build();
