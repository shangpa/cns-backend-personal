package com.example.cns.review.TradePost;

import com.example.cns.User.UserEntity;
import com.example.cns.admin.dto.TpReviewSimpleDTO;
...
public interface TpReviewRepository extends JpaRepository<TpReview, Long> {
    ...
    // 1. 내가 작성한 후기 조회
    @Query("SELECT new com.example.cns.admin.dto.TpReviewSimpleDTO(" +
