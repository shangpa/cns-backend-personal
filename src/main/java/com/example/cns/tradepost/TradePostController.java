...
import com.example.cns.tradepost.request.TradeCompleteRequest;
import com.example.cns.tradepost.request.TradeCompleteRequestRepository;
import com.example.cns.tradepost.request.TradeCompleteRequestService;
import com.example.cns.tradepost.request.UserSimpleDTO;
import com.example.cns.tradepost.up.TradePostUpResult;
import com.example.cns.tradepost.up.TradePostUpService;
...
public class TradePostController {
    ...
    public ResponseEntity<TradePostUpResult> up(
            @PathVariable Long id,
            @AuthenticationPrincipal com.example.cns.dto.CustomUserDetails userDetails
    ) {
