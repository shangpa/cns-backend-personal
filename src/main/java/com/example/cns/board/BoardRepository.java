...
import com.example.cns.admin.dto.BoardAdminListResponseDTO;
...
""")
    ...
    @Query("SELECT new com.example.cns.admin.dto.BoardAdminListResponseDTO(b.id, b.writer.username, b.content, b.createdAt) " +
            "FROM Board b")
